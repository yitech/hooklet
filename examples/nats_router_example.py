...
import logging
import signal
from hooklet.eventrix.collection import ExampleRouterEmitter, ExampleRouterHandler
...
async def main():
    ...
    emitter = ExampleRouterEmitter(pilot=nats_pilot, subject="example", router_key="k")
    handler = ExampleRouterHandler(pilot=nats_pilot)
